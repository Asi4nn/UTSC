...
CmdNode *newCmdNode(char cmd[10], int val) {
   ...
   */
    ...
    if(strcmp(cmd, "penup") == 0 || strcmp(cmd, "pendown") == 0 || strcmp(cmd, "right") == 0 || strcmp( cmd, "left") == 0 || strcmp(cmd, "forward") == 0 || strcmp(cmd, "backward") == 0 || strcmp(cmd, "colour") == 0 || strcmp(cmd, "loop") == 0){
   ...
   */
    ...
    while(head != NULL){
        ...
        if (strcmp(head -> cmd, "loop") == 0){
            ...
            line_count += 1;
            CmdNode *loop_head = head -> loop_head;
            while (loop_head != NULL){
                if((strcmp(loop_head -> cmd, "penup") == 0) || (strcmp(loop_head -> cmd, "pendown") == 0) || (strcmp(loop_head -> cmd, "right") == 0) || (strcmp(loop_head -> cmd, "left") == 0)){
                    printf("  %3d: %s\n", line_count, loop_head -> cmd);
                }
                else{
                    printf("  %3d: %s %d\n", line_count, loop_head -> cmd, loop_head -> val);
                }
                line_count += 1;
                loop_head = loop_head -> next;
            }
        }
        else if((strcmp(head -> cmd, "penup") == 0) || (strcmp(head -> cmd, "pendown") == 0) || (strcmp(head -> cmd, "right") == 0) || (strcmp(head -> cmd, "left") == 0)){
   ...
   */
    ...
    while(head != NULL){ //this list goes through the list to see if their is the same command name
        if (strcmp(head -> cmd, "loop") == 0){
            ...
            CmdNode *loop_head = head -> loop_head;
            while (loop_head != NULL){
                if((strcmp(loop_head -> cmd, "penup") == 0) || (strcmp(loop_head -> cmd, "pendown") == 0) || (strcmp(loop_head -> cmd, "right") == 0) || (strcmp(loop_head -> cmd, "left") == 0) && (strcmp(loop_head -> cmd, cmd) == 0)){
                    printf("%3d: %s\n", line_count, loop_head -> cmd);
                }
                else if(strcmp(loop_head -> cmd, cmd) == 0){
                    printf("%3d: %s %d\n", line_count, loop_head -> cmd, loop_head -> val);
                }
                line_count += 1;
                loop_head = loop_head -> next;
        ...
        else if(((strcmp(head -> cmd, "penup") == 0) || (strcmp(head -> cmd, "pendown") == 0) || (strcmp(head -> cmd, "right") == 0) || (strcmp(head -> cmd, "left") == 0)) && (strcmp(head -> cmd, cmd) == 0)){
            printf("%3d: %s\n", line_count, head -> cmd);
        }
    ...
    while(head != NULL){
        if (strcmp(head -> cmd, "loop") == 0 ){
            for (int i = 0; i < head -> val; i++){
                CmdNode *loop_head = head -> loop_head;
                while (loop_head != NULL){
                    if (strcmp(loop_head -> cmd, "penup") == 0 ){
                        pen = 1;
                    }
                    else if(strcmp(loop_head -> cmd, "pendown") == 0){
                        pen = 0;
                    }
                    else if (strcmp(loop_head -> cmd, "right") == 0){
                        facing += 1;
                        if(facing > 3){
                            facing = 0;
                        }
                    }
                    else if (strcmp(loop_head -> cmd, "left") == 0){
                        facing -= 1;
                        if(facing < 0){
                            facing = 3;
                        }
                    }
                    else if (strcmp(loop_head -> cmd, "forward") == 0){
                        if(facing == 0){
                            if(x_axis + loop_head -> val < SIZEX){ //if it is at the end of the screen then it shouldn't move forward
                                if(pen == 0){
                                    drawLine(im, x_axis, y_axis, x_axis + loop_head -> val, y_axis, colour_track);
                                    //turtle moves forward head -> val times
                                }
                                x_axis += loop_head -> val; // if the turtle is facing right, then it should move along the x axis, not the y axis
                            }
                            else{
                                if(pen == 0){
                        ...
                        if(facing == 1){
                            if(y_axis + loop_head -> val < SIZEY){ //if it is at the end of the screen then it shouldn't move forward
                                if(pen == 0){
                                    drawLine(im, x_axis, y_axis, x_axis, y_axis + loop_head -> val, colour_track);
                                }
                                //turtle moves forward head -> val times
                                y_axis += loop_head -> val;
                            }
                            else{
                                if(pen == 0){
                        ...
                        if(facing == 2){
                            if(x_axis - loop_head -> val > 0){ //if it is at the end of the screen then it shouldn't move forward
                                if(pen == 0){
                                    drawLine(im, x_axis, y_axis, x_axis - loop_head -> val, y_axis, colour_track);
                                }
                                //turtle moves forward head -> val times
                                x_axis -= loop_head -> val;
                            }
                            else{
                                if(pen == 0){
                        ...
                        if(facing == 3){
                            if(y_axis - loop_head -> val > 0){ //if it is at the end of the screen then it shouldn't move forward
                                if(pen == 0){
                                    drawLine(im, x_axis, y_axis, x_axis, y_axis - loop_head -> val, colour_track);
                                }
                                //turtle moves forward head -> val times
                    ...
                    else if(strcmp(loop_head -> cmd, "backward") == 0){
                        if(facing == 2){
                            if(x_axis + loop_head -> val < SIZEX){ //if it is at the end of the screen then it shouldn't move forward
                                if(pen == 0){
                                    drawLine(im, x_axis, y_axis, x_axis + loop_head -> val, y_axis, colour_track);
                    ...
                    else if (strcmp(loop_head -> cmd, "colour") == 0){
                        colour_track = loop_head -> val;
                    }
                    printf(" %d, %d, %d\n", x_axis, y_axis, pen);
                    loop_head = loop_head -> next;
                }
