...
## Daily Stand-ups (max 10 marks)
  ...
  Feedback: 2 group members did not participate in standup 1
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1   
    Feedback: TM8-65, TM8-15 not broken down into tasks/subtasks
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1 
    Feedback: No pull requests for TM8-65 and TM8-15 found
  ...
  - Is each pull request made from a separate branch for each individual task? (max 5 marks)
    ...
    Your Mark: 3
    Feedback: Some pull requests not found for branches TM8-16, TM8-15, TM8-65
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 4
    Feedback: CRC cards present but not found in the system design document
...
TM8-64,TM8-65 are not done.

username, description and profile page link on profile page needs to have an extra column to describe what it is.
