...
Standup Missing: Sprint 2 Standup 3 from Hunter
---
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    There's a few commits missing the ticket format:
    https://github.com/UTSCCSCC01/project-team8/pull/14/commits
    https://github.com/UTSCCSCC01/project-team8/pull/13/commits
    https://github.com/UTSCCSCC01/project-team8/pull/11/commits
...
## Documentation (max 1 mark)
  ...
  Read through documentation, didn't really tell me anything useful.
...
Comment: 
Backend and frontend integration is not finished.
Sprint 1 TM8-18 is not finished as the left demo. 
