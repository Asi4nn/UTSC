...
**Team Name:** Team8  
**Github:** https://github.com/UTSCCSCC01/project-team8
...
## Planning Meetings (RPM.md, sprintN.md) (max 5 marks)
  ...
  - RPM.md (Release Planning Meetings) (max 3 marks)
    ...
    Your Mark: 1
    Feedback: No references to user stories made. Release goals are a bit vague
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Goal specified. Spikes not identified. Not sufficient clarity on which user stories will be completed and tasks breakdown.

  Planning Meetings Total Mark: 2 / 5
...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 0
    Feedback: User stories partially formatted. Remember to follow the user story format: As a user ___, I want to ____, so that _____.
...
## Tracking on Jira  (max 20 marks) 
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 0
    Feedback:  No assignees specified on Jira
  ...
  - Is each pull request made from a separate branch for each individual task? (max 5 marks)
    ...
    Your Mark: 4
    Feedback: Userstory TM8-1 not made in a separate branch or pull request made
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 0
    Feedback: Majority of the commit messages do not begin with the ticket number followed by the task/commit change description
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 1
    Feedback: Only found tasks assigned to two group members
...
Tracking on Jira Total Mark: 12 / 20
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  System Design Mark: 4 / 10
  Feedback: System design document is missing
...
---
Comment: The backend and frontend of the issue TM8-4/TM8-24 are not being integreated. TM8-1 has bug while it was running. 
TM8-3 - Sprint 1 left
