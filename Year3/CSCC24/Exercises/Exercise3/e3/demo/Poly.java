...
public class Poly {
  ...
  private static void demoInterleave() {
    ...
    List<String> xs1 = Arrays.asList(new String[] {"aaa", "bbb", "aaa"});
    ...
    List<Integer> xs3 = Arrays.asList(new Integer[] {});
    List<Integer> ys3 = Arrays.asList(new Integer[] {});

    System.out.println(String.format("Interleaving %s and %s produces:\n\t%s", xs3, ys3,
        Interleaver.interleave(xs3, ys3)));
  }
